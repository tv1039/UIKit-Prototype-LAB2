...
class DataManager {
    ...
    init () {
        ...
        userDataArray = [
            ...
            User(id: "udi", date: "2024-01-17", emoji: "😁", content: "가격 대비 만족도가 높은 이 음식점은 특히 반찬 다양성에서 빛을 발합니다. 테이블에 나온 반찬은 엄청나게 다양했고, 각각의 맛이 정말 훌륭했습니다. 고기와 해산물, 채소 등 다양한 식재료를 사용하여 조리한 반찬들은 정갈하면서도 맛있게 느껴졌습니다.가격은 적당한 편이었고, 이에 대한 가치를 느낄 수 있었습니다. 양도 푸짐하게 제공되어 가족끼리 함께 나누며 먹을 만큼 충분했습니다. 서비스도 친절하고 신속해서 기분 좋게 식사를 할 수 있었습니다.한식 백반을 좋아하는 분들에게 강력하게 추천하고 싶은 음식점이었습니다. 다양한 반찬과 적당한 가격, 훌륭한 서비스로 부모님과의 소중한 시간을 더욱 특별하게 만들어준 곳이었습니다. 다음에도 기회가 된다면 꼭 다시 방문하고 싶은 곳입니다", star: 4.6, pin: false, food: getFoodData(name: "한울밥상")),
            
            User(id: "Gwan", date: "2024-01-17", emoji: "🥘", content: "뼈다귀 해장국 드세요 얼큰 안먹으면 쫄보", star: 4.7, pin: false, food: getFoodData(name:"밀리네 감자탕")),
            ...
            """, star: 4.5, pin: false, food: getFoodData(name: "당산옛날곱창")),
...
""", star: 2.0, pin: false, food: getFoodData(name: "운봉산장")),
...
""", star: 4.6, pin: false, food: getFoodData(name: "풍류랑"))
        ]
    }
